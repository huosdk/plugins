...
import io.flutter.plugins.deviceinfo.utils.ApplicationHolder;
import io.flutter.plugins.deviceinfo.utils.DeviceUtils;
import io.flutter.plugins.deviceinfo.utils.HuoPhoneUtil;
import io.flutter.plugins.deviceinfo.utils.NetworkUtils;
import io.flutter.plugins.deviceinfo.utils.PhoneUtils;
...
public class DeviceInfoPlugin implements MethodCallHandler {
    ...
    public void onMethodCall(MethodCall call, Result result) {
        if (call.method.equals("getAndroidDeviceInfo")) {
            ...
            //火速通用参数
            build.put("deviceId", HuoPhoneUtil.getDeviceId());
//      idfv安卓为安卓id
            ...
            build.put("mac", DeviceUtils.getMacAddress());
